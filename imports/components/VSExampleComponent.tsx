...
const VSExampleComponent = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-20 left-10 w-24 h-24 rounded-[40%] rotate-12
                     opacity-[var(--theme-float-opacity)]
                     bg-[var(--theme-float-bg-primary)]
                     animate-float-slow"
      ></div>
      <div
        className="absolute bottom-40 right-20 w-32 h-32 rounded-[30%] -rotate-6
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <div
            className="bg-[var(--theme-bg-secondary)]/10
                       border border-theme-primary mb-4 py-2 px-4
                       inline-block rounded-full"
          >
            <span className="text-theme-primary">Example Component</span>
          </div>

          <h2
            className="text-theme-primary text-4xl md:text-5xl
          ...
          <p className="text-theme-secondary text-xl mb-2 max-w-3xl mx-auto">
            This example demonstrates proper implementation of VS styling using
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div
            className="example-card relative bg-theme-gradient-card
                        rounded-lg p-6
          ...
          >
            <div
              className="w-12 h-12 rounded-full bg-theme-gradient-primary
          ...
          >
            <div
              className="w-12 h-12 rounded-full bg-theme-gradient-secondary
                         flex items-center justify-center mb-4"
            >
            ...
            <button
              className="bg-theme-gradient-secondary
                             text-theme-on-primary-4 py-2 rounded-full
                             shadow-theme-sm
                             transition-all transition-theme-bounce
                             hover-bubbly-sm"
          ...
          >
            <div
              className="w-12 h-12 rounded-full bg-theme-gradient-accent
                         flex items-center justify-center mb-4"
            >
            ...
            <p className="text-theme-secondary mb-4">
              Always use useGSAP with proper context for animations, ensuring
              correct component lifecycle management.
            </p>

            <button
              className="bg-theme-gradient-accent
                             text-theme-on-primary-4 py-2 rounded-full
                             shadow-theme-sm
                             transition-all transition-theme-bounce
                             hover-bubbly-sm"
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[var(--theme-accent-secondary)]/5 border-b border-theme-border-light">
                  ...
                  <th className="p-4 text-left text-theme-primary">
                    Old Approach
                  </th>
                  <th className="p-4 text-left text-theme-primary">
                    New Approach
        ...
        {/* Pro tip */}
        <div
          className="mt-12 bg-theme-gradient-accent
                     text-theme-on-rimary-6 rounded-lg
                     shadow-theme-md
                     max-w-4xl mx-auto"
        >
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-theme-on-primary/90">
                Always test your components in both light and dark mode. The
                most common issue is forgetting to provide theme-aware variables
                or using competing light/dark mode styles instead of a single
                source of truth.
              </p>
            </div>
          </div>
