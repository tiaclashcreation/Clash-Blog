...
const VerticalShortcutApplicationForm = ({ onClose }: { onClose?: () => void }) => {
  ...
  return (
    <div className="rounded-xl overflow-y-auto max-h-[80vh] bg-theme-surface transition-colors transition-theme-normal">
      <div className="text-center p-8 pb-6">
        <h1 className="text-3xl md:text-4xl font-bold mb-3 text-theme-primary transition-colors transition-theme-normal">
          Vertical Shortcut: Transform Your Content into a Revenue Machine
        </h1>
        <p className="text-xl text-theme-secondary md:max-w-2xl mx-auto transition-colors transition-theme-normal">
          Complete this application to join our exclusive program and start your journey to content mastery.
        </p>
      </div>
      
      <Card className="shadow-theme-md border-theme-border mb-10 relative overflow-hidden transition-all transition-theme-normal">
        <CardHeader className="bg-theme-accent-secondary text-theme-on-primary-t-lg transition-colors transition-theme-normal">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-theme-primary dark:text-theme-on-primary-b pb-2 bg-theme-secondary/20 dark:border-theme-border-light">Personal Information</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "firstName"> }) => (
                      <FormItem>
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">First Name</FormLabel>
                        <FormControl>
                          <Input placeholder="John" {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "lastName"> }) => (
                      <FormItem>
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">Last Name</FormLabel>
                        <FormControl>
                          <Input placeholder="Doe" {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "email"> }) => (
                      <FormItem>
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">Email Address</FormLabel>
                        <FormControl>
                          <Input type="email" placeholder="you@example.com" {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "linkedin"> }) => (
                      <FormItem>
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">LinkedIn Profile</FormLabel>
                        <FormControl>
                          <Input placeholder="linkedin.com/in/yourprofile" {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <div className="p-5 rounded-lg border border-theme-primary/20 bg-theme-gradient shadow-theme-sm transition-all transition-theme-normal">
                <h3 className="text-xl font-semibold text-theme-primary mb-4 transition-colors transition-theme-normal">What You'll Achieve in 10 Weeks:</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-theme-primary border-b pb-2 border-theme-border transition-all transition-theme-normal">Qualification Questions</h3>
                ...
                <FormField
                  ...
                  render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "commitment"> }) => (
                    <FormItem className="space-y-3">
                      <FormLabel className="text-theme-primary transition-colors transition-theme-normal">
                      ...
                      <FormControl>
                        ...
                        >
                          <FormItem className="flex items-center space-x-3 space-y-0">
                            ...
                            <FormLabel className="font-normal text-theme-primary transition-colors transition-theme-normal">
                ...
                <FormField
                  ...
                  render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "industry"> }) => (
                    <FormItem>
                      <FormLabel className="text-theme-primary transition-colors transition-theme-normal">What kind of work do you do? (Industry, seniority, etc.)</FormLabel>
                      <FormControl>
                        <Input {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "followerCount"> }) => (
                      <FormItem>
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">What are your total follower counts across all platforms?</FormLabel>
                        <FormControl>
                          <Input {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "location"> }) => (
                      <FormItem>
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">Where are you based?</FormLabel>
                        <FormControl>
                          <Input {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                        </FormControl>
                        <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "contentTopics"> }) => (
                    <FormItem>
                      <FormLabel className="text-theme-primary transition-colors transition-theme-normal">What topics do you create content about?</FormLabel>
                      <FormControl>
                        <Input {...field} className="bg-theme-surface transition-colors transition-theme-normal" />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "goals"> }) => (
                    <FormItem>
                      <div className="mb-2">
                        <FormLabel className="text-theme-primary transition-colors transition-theme-normal">What do you want to achieve? (Select all that apply)</FormLabel>
                      </div>
                ...
                <FormField
                  ...
                  render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "revenueTarget"> }) => (
                    <FormItem className="space-y-3">
                      <FormLabel className="text-theme-primary transition-colors transition-theme-normal">How much are you aiming to make per month?</FormLabel>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                          defaultValue={field.value}
                ...
                <FormField
                  ...
                  render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "biggestChallenge"> }) => (
                    <FormItem className="space-y-3">
                      <FormLabel className="text-theme-primary transition-colors transition-theme-normal">What do you struggle with the most when it comes to scaling your brand?</FormLabel>
                      <FormControl>
                        <RadioGroup
                          onValueChange={field.onChange}
                          defaultValue={field.value}
              ...
              {/* Program details */}
              <div className="p-6 rounded-lg bg-theme-gradient-primary shadow-theme-md transition-all transition-theme-normal">
                ...
                <Alert className="bg-theme-accent-tertiary border-none text-theme-on-primary-4 transition-colors transition-theme-normal">
                ...
                render={({ field }: { field: ControllerRenderProps<ApplicationFormData, "termsAccepted"> }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel className="text-theme-primary transition-colors transition-theme-normal">
                        I agree to the <a href="#" className="text-theme-accent-tertiary underline transition-colors transition-theme-normal">Terms and Conditions</a> and understand the program investment of £6,500
                      </FormLabel>
                    </div>
                    <FormMessage />
                  </FormItem>
              ...
              <Button 
                type="submit" 
                className="w-full py-6 text-lg bg-theme-gradient-primary text-theme-on-primary-theme-btn hover-bubbly transition-all transition-theme-bounce"
              >
                Submit Application Now
              </Button>
              
              <p className="text-center text-sm text-theme-secondary transition-colors transition-theme-normal">
